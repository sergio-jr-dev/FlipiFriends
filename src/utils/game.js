...
export const LEVEL_MESSAGES = [
  ...
  'Increíble memoria. Listo para continuar.',
  'Gran nivel. Sigue así.',
  'Fantástico. Estás mejorando mucho.',
  'Muy bien hecho. A por el siguiente reto.',
  'Qué buen nivel. Continúa jugando.',
  'Lo estás haciendo de maravilla.',
];

export const FINAL_MESSAGES = [
  'Eres un campeón de FlipiFriends.',
  'Partida completa. Has encontrado todas las parejas.',
  'Misión cumplida. Juego terminado con éxito.',
  'Has terminado todos los niveles. Súper logro.',
  'Increíble final. Te has salido.',
